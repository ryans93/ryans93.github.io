...
function Header() {
    return (
        <section id="header" className="bg-red-700/50 text-white flex w-[85%] grow-0 flex md:flex-row flex-col h-fit lg:p-[2rem] p-[1rem] my-[3rem] border-white-500 border-3">
            ...
            <div className="basis-2/3 flex flex-col justify-evenly items-center lg:pl-[2rem] pl-[1rem]">
                ...
                <h5 className="flex w-full xl:flex-row xl:justify-evenly flex-col items-center py-[1rem] underline">
